...
import { FaDollarSign, FaUsers, FaFolderOpen, FaChartBar } from 'react-icons/fa'
        ...
        <React.Fragment>
            <div style={{display:'flex' ,gap:30 ,padding:30 ,border:'solid 0px red'}} >
                <div className={styles.service}>
                    <div><FaDollarSign size={32} color="#5B0C4E" /></div>
                ...
                <div className={styles.service}>
                    <div><FaUsers size={32} color="#5B0C4E" /></div>
                ...
                <div className={styles.service}>
                    <div><FaFolderOpen size={32} color="#5B0C4E" /></div>
                ...
                <div className={styles.service}>
                    <div><FaChartBar size={32} color="#5B0C4E" /></div>
