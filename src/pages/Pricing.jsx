                    ...
                    <div className="pricings">
                        ...
                        <div className="pricing-block">
                            ...
                            <ul>
                                ...
                                <li>Inventory management up to 10 products</li>
                        ...
                        <div className="pricing-block growth-block">
                            <h3 style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
                                ...
                                <span className="most-popular-badge">
                                    <GiImperialCrown size={13} style={{color:'#FFD700', flexShrink:0}} />
                                    Most Popular
                                </span>
                            </h3>
                            ...
                            <ul>
                                ...
                                <li>Manage finances</li>
                                <li>Inventory management up to 50 products</li>
                                <b>Priority support</b>
                        ...
                        <div className="pricing-block">
                            ...
                            <ul>
                                ...
                                <li>Manage finances</li>
                                <li>Inventory management up to 100 products</li>
                                <b>Priority support</b>
                                <li>Priority: Email, chat and phone supports</li>
                            </ul>
                        </div>
                        ...
                        <div className="pricing-block custom-pricing-block">
                            ...
                            <ul>
                                ...
                                <li>Custom inventory solutions</li>
